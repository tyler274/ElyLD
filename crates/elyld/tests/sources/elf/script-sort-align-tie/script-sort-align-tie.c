// GNU 2.46 SORT_BY_ALIGNMENT ties break by name, not source order.
...
//#ExpectSectionBytes:.data=0x1100000000000000 0..8
//#ExpectSectionBytes:.data=0x3300000000000000 8..16
