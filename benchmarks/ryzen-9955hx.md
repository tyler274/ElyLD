...
The benchmarks include several other linkers for Linux as well as several recent versions of ElyLD.
This allows us to both compare between linkers and to see how ElyLD's performance is changing over
time.
...
CREL relocations are a new format for relocations that is significantly more compact. ElyLD has
